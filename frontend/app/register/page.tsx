        ...
        <div className="w-full max-w-md space-y-8 bg-white dark:bg-zinc-900 p-8 rounded-2xl shadow-xl border border-zinc-200 dark:border-zinc-800 transition-all duration-350">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            <div className="space-y-4 rounded-md">
              <div>
                <label htmlFor="name-address" className="block text-sm font-medium text-zinc-700 dark:text-zinc-305 mb-1.5">
                  Full Name
                </label>
                <input
                  id="name-address"
              ...
              <div>
                <label htmlFor="confirm-password" className="block text-sm font-medium text-zinc-700 dark:text-zinc-305 mb-1.5">
                  Confirm Password
                </label>
                <input
                  id="confirm-password"
